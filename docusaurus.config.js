...
const config = {
  title: 'ThingPark Location',
  tagline: 'ThingPark Location documentation',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/actility/tpxle-doc/',
            label: 'GitHub',
            position: 'right',
          },
        ],
