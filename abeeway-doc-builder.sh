...
PACKAGE_DIR=${CURRENT_DIR}/docs/.vuepress/dist
...
yarn add vuepress-theme-actility@4.1.0
yarn add vuepress-theme-abeeway

echo "Build project"

vuepress build docs abeeway


ARCHIVE_NAME=abeeway-thingpark-location_doc.tar.gz
TARGET_DIR=./target
