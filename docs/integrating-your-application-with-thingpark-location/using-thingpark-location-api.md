...
1. The first step is to authenticate with ThingPark Location using your credentials. If you are using community platform, see [here](https://dx-api.thingpark.io/getstarted/readme.md#/). For other platforms, see [here](../troubleshooting-support/thingpark-location-urls.md#how-to-create-a-free-account).
...
| ------------ | -------- | -------- | 
| **Example JSON [geofenceAlarm](https://dx-api.thingpark.io/location-connector/latest/doc/index.html#geofencealarm) object sent when entering Geofence** | [here](../tpxle-sample-payloads/tpxle-alarm-geofence-entering.md) | For more information on setting up Geofence, see [ThingPark Location Introduction (Section: Setting up Geofencing)](../documentation-library/thingpark-x-location-engine.md#thingpark-x-location-engine-trainings) |&nbsp; 
| **Example JSON [geofenceAlarm](https://dx-api.thingpark.io/location-connector/latest/doc/index.html#geofencealarm) object sent when leaving Geofence** | [here](../tpxle-sample-payloads/tpxle-alarm-geofence-leaving.md) | For more information on setting up Geofence, see [ThingPark Location Introduction (Section: Setting up Geofencing)](../documentation-library/thingpark-x-location-engine.md#thingpark-x-location-engine-trainings) | 
| **Example JSON [ResolvedTracker](https://dx-api.thingpark.io/location-connector/latest/doc/index.html#resolvedtrackerasassettracker) object sent when the tracker sends its configuration parameters** | [here](../tpxle-sample-payloads/tpxle-output-configuration.md) | The tracker sends its configuration when either there is change of its [configuration parameter](../abeeway-trackers-reference-guide/AbeewayRefGuide/downlink-messages/parameters-configuration/readme.md) by sending LoRaWAN downlink or when the parameter values are requested by sending [device configuration downlink](../abeeway-trackers-reference-guide/AbeewayRefGuide/downlink-messages/request-device-configuration/readme.md) |  
| **Example [geofencingNotification](https://dx-api.thingpark.io/location-connector/latest/doc/index.html#geofencingnotification) JSON object sent when entering/exiting the different BLE geozones.** | [BLE Geozoning entry](../tpxle-sample-payloads/tpxle-output-event-geofencing-entry.md)<br/>[BLE Geozoning exit](../tpxle-sample-payloads/tpxle-output-event-geofencing-exit.md)<br/>[BLE Geozoning hazard](../tpxle-sample-payloads/tpxle-output-event-geofencing-hazard.md)<br/>[BLE Geozoning safe](../tpxle-sample-payloads/tpxle-output-event-geofencing-safe.md)| This JSON object is related to BLE Geozoning feature. For more details about BLE Geozoning feature, see [BLE Geozoning](../documentation-library/abeeway-trackers-documentation.md#abeeway-firmware-trainings) and [AN-011_BLE_geozoning](../documentation-library/abeeway-trackers-documentation.md#application-notes) |  
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *eventType* object for the tracker events** | [Geolocation Start Event](../tpxle-sample-payloads/tpxle-output-event-geoloc-start.md)| This JSON object is sent when the tracker reports events. The *geoloc_start* event is configured in the tracker firmware by setting bit 6=0 in *config_flags*. | 
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *eventType* object for the tracker events** | [Motion Start Event](../tpxle-sample-payloads/tpxle-output-event-motion-start.md)<br/>[Motion End Event](../tpxle-sample-payloads/tpxle-output-event-motion-end.md)| This JSON object is sent when the tracker reports events. The *motion_start* and *motion_end* events are configured in the tracker firmware by setting bit 8=1 &amp; bit 9=1 in *config_flags*. | 
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *eventType* object for the tracker events** | [SoS Start Event](../tpxle-sample-payloads/tpxle-output-event-sos-mode-start.md)<br/>[SoS End Event](../tpxle-sample-payloads/tpxle-output-event-sos-mode-stop.md)| This JSON object is sent when the tracker reports events. The *sos_start* and *sos_end* events are sent when the tracker enters [SoS](../abeeway-trackers-reference-guide/AbeewayRefGuide/functioning/sos/readme.md) mode.| 
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *messageType* object for the tracker heartbeat message** | [Heartbeat](../tpxle-sample-payloads/tpxle-output-heartbeat.md)| This JSON object is sent when the tracker reports [heartbeat message](../abeeway-trackers-reference-guide/AbeewayRefGuide/uplink-messages/heartbeat/readme.md).| 
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *messageType* object for the tracker position message** | [BLE position](../tpxle-sample-payloads/tpxle-output-position-ble.md)<br/>[GPS position](../tpxle-sample-payloads/tpxle-output-position-gps.md)<br/>[GPS timeout](../tpxle-sample-payloads/tpxle-output-position-gps_timeout.md)<br/>[LPGPS position](../tpxle-sample-payloads/tpxle-output-position-lpgps.md)<br/>[LPGPS no position](../tpxle-sample-payloads/tpxle-output-position-lpgps-no_position.md)<br/>[WiFi position](../tpxle-sample-payloads/tpxle-output-position-wifi.md)| This JSON object is sent when the tracker reports [position messages](../abeeway-trackers-reference-guide/AbeewayRefGuide/uplink-messages/position/readme.md) or [Extended position messages](../abeeway-trackers-reference-guide/AbeewayRefGuide/uplink-messages/extended-position/readme.md). The filtered positions from the backend are in [ResolvedPosition](https://dx-api.thingpark.io/location-connector/latest/doc/index.html#resolvedposition) object|
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *messageType* object for the tracker Scan Collection messages** | [BLE Scan collection Eddystone](../tpxle-sample-payloads/tpxle-output-scancollection-ble-eddystone-id.md)<br/>[BLE Scan collection MAC Address](../tpxle-sample-payloads/tpxle-output-scancollection-ble-mac.md)<br/>[Wifi Scan collection](../tpxle-sample-payloads/tpxle-output-scancollection-wifi.md)| This JSON object is sent when the tracker reports [Scan Collection messages](../abeeway-trackers-reference-guide/AbeewayRefGuide/uplink-messages/collection-scan/readme.md). For more details about Scan Collection feature, see [Scan Collection](../documentation-library/abeeway-trackers-documentation.md#abeeway-firmware-trainings) and [AN-003_ScanCollection](../documentation-library/abeeway-trackers-documentation.md#application-notes) | 
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *messageType* object for the tracker shock detection message** | [Shock detection](../tpxle-sample-payloads/tpxle-output-shock_detection.md)| This JSON object is sent when the tracker reports [shock detection message](../abeeway-trackers-reference-guide/AbeewayRefGuide/uplink-messages/shock-detection/readme.md#accelerometer-shock-data).| 
| **Example [TrackerAsAssetTracker](https://dx-api.thingpark.io/location/latest/doc/index.html#trackerasassettracker) JSON object which contains *messageType* object for the tracker shock detection message** | [Shutdown](../tpxle-sample-payloads/tpxle-output-shutdown.md)| This JSON object is sent when the tracker reports [shutdown message](../abeeway-trackers-reference-guide/AbeewayRefGuide/uplink-messages/shutdown/readme.md).| 
## DX Admin API
...
If you are using some other ThingPark Location platform, see [ThingPark Location Platform URLs](../troubleshooting-support/thingpark-location-urls.md)
