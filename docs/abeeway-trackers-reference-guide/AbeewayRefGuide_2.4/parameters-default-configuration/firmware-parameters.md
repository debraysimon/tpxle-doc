...
- Refer to the application note [AN-016_GPS_LPGPS](../../../documentation-library/abeeway-trackers-documentation#application-notes) for more details about these parameters.  
:::
...
:::tip Note  
Refer to the application note [AN-011_BLE_geozoning](../../../documentation-library/abeeway-trackers-documentation#application-notes) for more details about these parameters.  
:::
