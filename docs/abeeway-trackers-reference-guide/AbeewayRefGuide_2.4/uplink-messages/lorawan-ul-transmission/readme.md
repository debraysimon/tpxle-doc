...
Refer to the dedicated application note [AN-002_LoRa_Transmission](../../../../documentation-library/abeeway-trackers-documentation#application-notes) strategy for more details.
