# Factory default configuration
 ...
 It is the configuration of the trackers after a firmware update if no configuration file is used.

|Setting  |Value       |Setting     |Value       |
|---------|-----------|-----------|-----------------------|
|mode|0 (standby)|shock_detection|0 (disabled)|
...
|periodic_pos_period|0 (disabled)|geofencing_collect_period|60 seconds|
|geoloc_sensor|1 (GPS)|***ble_rssi_filter***|***-85 dBm***|
|geoloc_method|1 (GPS)|temperature_high|255 (disabled)|
|***motion_nb_pos***|1|temperature_low|255 (disabled)|
|gps_timeout|240 seconds|temperature_action|0|
|agps_timeout|45 seconds|transmit_strat_custom|0|
...
|Bit1|Very long button press to switch to off mode: Activated (1)|collection_ble_filter_type|0 (none)|
|**Bit2**|**no more used (1)**|collection_ble_filter_main_1|0|
...
|Bit6|First WIFI scan when geolocation starts. Activated, (Send a geoloc start message instead)|battery_capacity|-1 (provisioned value should not be modified)|
|Bit7|LED blinks when a GPS fix is received: Disabled (0)|reed_switch_configuration|3 for the compact tracker, 0 for the other trackers|
|Bit8|Motion start message: Disabled|gnss_constellation|4|
...
|Bit15|Forbid the mode OFF: Disabled (0)|prox_exposure_100|50 cm|
|Bit16|***Melody played during SOS: activated (1)***|prox_exposure_150|22 cm|
|Bit17|Automatic data rate selection: deactivated (0)|prox_exposure_200|13 cm|
|**Bit18**|**Extended position payload : deactivated (0)**|prox_exposure_250|0 cm|
|transmit_strat|2|prox_exposure_300|0 cm|
