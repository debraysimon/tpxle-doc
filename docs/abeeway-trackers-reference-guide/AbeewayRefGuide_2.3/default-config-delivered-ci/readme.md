...
|lora_period|600 seconds (10 minutes)|motion_duration|360 seconds|
...
|***motion_nb_pos***|1|temperature_low|-0 °C|
...
|**config_flags**|**0x2C039**|collection_scan_type|0 (deactivated)|
|Bit0|Frame pending mechanism: Activated|collection_nb_entry|20|
|Bit1|Very long button press to switch to off mode: disabled|collection_ble_filter_type|0 (none)|
...
|Bit15|Forbid the mode OFF: activated (1)|prox_exposure_100|50 cm|
|Bit16|Melody played during SOS: deactivated (0)|prox_exposure_150|22 cm|
