...
<sup>(1)</sup> Refer to the section [Reed switch interface](../functioning/user-interfaces/readme.md#reed-switch-interface) for reed switch interface explanation.
:::
