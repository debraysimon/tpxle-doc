...
Refer to the dedicated application note [AN-002_LoRa_Transmission](../../../D-Reference/DocLibrary_R/AbeewayTrackers_R.md#application-notes) strategy for more details.
