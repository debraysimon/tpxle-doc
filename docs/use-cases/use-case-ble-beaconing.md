...
4. Apply the necessary BLE beaconing parameters. For more information on the BLE beaconing parameters, see [BLE Beaconing training](/D-Reference/DocLibrary_R/AbeewayTrackers_R.md#abeeway-firmware-trainings) and [AN-019_BLE Beacon transmission](/documentation-library/abeeway-trackers-documentation.md#application-notes)
