...
<table cellspacing="21">
        ...
        <td class="TableStyle-Alternate-Row-Color-BodyD-Column1-Body1">
            ...
            <div class="custom-block tip">
                ...
                <ul>
                    ...
                    <li>
                        Please refer to <a href="../../abeeway-trackers-reference-guide/AbeewayRefGuide/functioning/user-interfaces" >Abeeway Trackers Reference Guide</a> (Chapter: User Interfaces) on how to interpret LEDs to indicate battery level
                    </li>
                </ul>
            </div>
        </td>
    ...
    <tr>
        ...
        <td>
          Apply <a href="../ReDoJoinRequestMT_T" class="MCXref xref">Re-doing a join request</a>.
        </td>
    </tr>
    </tbody>
</table>
...
This table gives you quick access to the tracker commands. For more information on all the commands and LED patterns, see [Abeeway Trackers Reference Guide](../../abeeway-trackers-reference-guide/AbeewayRefGuide/functioning/user-interfaces/readme.md).
