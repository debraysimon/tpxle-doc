...
![img](../troubleshooting-support/FirmwareUpdateOverview_R/FirmwareUpdateMobileApp_R/images/forgetBluetoothbond.png)
...
* **Remove the Bluetooth bond on the tracker**: When you restart the tracker, you should hear the [Bluetooth advertisement melody](https://actilitysa.sharepoint.com/:u:/t/aby/EWdjoLPV12BGiHsZptjIOrABxRdVpqTLLJM72K795IUQsg?e=rngKdO) for 15 seconds and the tracker will continue to advertise for 10 minutes<sup>(1)</sup>. After 10 minutes, you must restart the tracker again for it to advertise if it’s not bonded. If you do not hear this melody, and you flashed the tracker correctly with the right firmware and config files, then you need to remove the Bluetooth bond on the tracker in either one of the following ways:
   * **[With the button sequence](../trackers-overview/MicroTracker_C/MicroTrackerCommands_R)** (This is applicable only to Micro Tracker/Smart Badge): 
...
![img](./images/appLocationPermission.png)
...
![img](../troubleshooting-support/FirmwareUpdateOverview_R/FirmwareUpdateMobileApp_R/images/addtracker.png)

The following screens show the workflow of adding the tracker to the mobile app account.

![img](images/addtrackerWorkflow.png)
...
![img](images/advancedSettings.jpg)

### Developer mode

:::warning Note
This feature requires the mobile app user account to have an admin role. Please open a ticket on [Abeeway support](../troubleshooting-support/FAQ_R/README.md) to upgrade the mobile app account to admin role.
:::
...
![img](images/appReportProblem.png)
...
![img](images/KeycloackLoginMobileApp.png)
