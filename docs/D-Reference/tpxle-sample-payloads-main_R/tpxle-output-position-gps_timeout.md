``` 
{
  ...
  "processedFeed" : {
    ...
    "payloadEncoded" : "034c34a0a10100000000",
    "sequenceNumber" : 18511,
    "receptionTime" : "2022-09-02T07:45:10.179Z",
    "dynamicMotionState" : "MOVING",
    "temperatureMeasure" : 36.941177,
    "processedPacket" : {
      "SNR" : 11.0,
      "RSSI" : -57.0,
  ...
  "uplinkPayload" : {
    ...
    "batteryStatus" : "OPERATING",
    "ackToken" : 10,
    "rawPositionType" : "GPS_TIMEOUT",
    "periodicPosition" : false,
    "timeoutCause" : "T0_TIMEOUT",
    "bestSatellitesCOverN" : [ 0, 0, 0, 0 ],
    "temperatureMeasure" : 36.9,
    "sosFlag" : 0,
    "appState" : 1,
    "dynamicMotionState" : "MOVING",
    "onDemand" : false,
    "payload" : "034c34a0a10100000000",
    "deviceConfiguration" : {
